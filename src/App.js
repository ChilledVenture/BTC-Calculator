      ...
      <div className="min-h-screen bg-white text-[var(--ink)] p-6">
        <div className="max-w-5xl mx-auto grid gap-6">
          ...
          <footer className="text-xs text-[var(--muted)] italic border-t border-[var(--line)] pt-3">
            Notes: Growth is applied to the prior-year balance, then drawdown is taken as a percentage of the after-growth balance. Only orange fields are editable; others auto-calculate.
          </footer>
        </div>
      </div>
    </>
